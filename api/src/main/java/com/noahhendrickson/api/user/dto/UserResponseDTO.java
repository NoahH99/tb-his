...
public class UserResponseDTO {
    ...
    public UserResponseDTO(UUID id, String firstName, String lastName, String fullName, String email, AccountStatus accountStatus, int initialHandicap, LocalDateTime createdAt, LocalDateTime updatedAt) {
        this.id = id;
